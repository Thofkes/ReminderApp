...
//    }
//
//    public ReminderContent.ReminderItem createReminder(String reminder) {
...
//                null, null, null);
//        cursor.moveToFirst();
//        ReminderContent.ReminderItem newReminder = cursorToReminder(cursor);
//        cursor.close();
//        return newReminder;
//    }
//
//    public void deleteReminder(ReminderContent.ReminderItem reminder) {
...
//    }
//
//    public List<ReminderContent.ReminderItem> getAllReminders() {
//        List<ReminderContent.ReminderItem> reminders = new ArrayList<ReminderContent.ReminderItem>();
//
//        Cursor cursor = database.query(MySQLiteHelper.TABLE_REMINDERS,
...
//            ReminderContent.ReminderItem remind = (ReminderContent.ReminderItem) reminder.getReminder();
